    ...
    for number_failed_nodes in 0: number_nodes - 1
        ...
        if number_failed_nodes != 0
            ...
            for failed_node in failed_nodes
                total_cpus_clocks_copy[failed_node] = 0
            end
        end
        objective_value, vnf_placement, virtual_link, clocks, throughput = GBD(number_slices, number_nodes, total_cpus_clocks_copy, adjacency_matrix, total_throughput, number_VNFs, number_cycles, traffic, delay_tolerance, number_failed_nodes, β)
